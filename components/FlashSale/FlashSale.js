...
export default function FlashSale({ products = [] }) {
    ...
    return (
        <section className="bg-[#0a0a0a] text-white py-10 md:py-16">
            <div className="max-w-site mx-auto px-4 md:px-6">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8 md:mb-10">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h2 className="text-xl md:text-[28px] font-extrabold tracking-tight text-white">
                                Limited Time <span className="text-brand-primary">Flash Sale</span>
                            </h2>
                            <div className="h-1 w-14 bg-brand-primary mt-2 rounded-full" />
                        </div>
                    </div>
                ...
                <div className="flex flex-col lg:flex-row gap-5 md:gap-6 items-stretch">
                    ...
                    <div className="w-full lg:w-[35%] flex-shrink-0">
                        <div className="relative w-full h-[120px] sm:h-[180px] lg:h-full min-h-[150px] rounded-lg overflow-hidden bg-white/5 border border-white/10 transition-all duration-300">
                            <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-4 md:p-6 z-10">
                                ...
                                <h3 className="text-xl md:text-3xl lg:text-4xl font-extrabold text-white mb-1 md:mb-2">Flash Sale</h3>
                                <p className="text-gray-400 text-[10px] md:text-sm lg:text-base mb-3 md:mb-4 hidden sm:block">Grab the best deals before they&apos;re gone!</p>
                    ...
                    <div className="flex-1 overflow-hidden flex flex-col justify-between">
                        {displayProducts.length > 0 ? (
                            ...
                            <div className="w-full h-full min-h-[200px] flex items-center justify-center text-gray-400 bg-white/5 rounded-lg border border-dashed border-white/20">
...
function TimerBlock({ value, label }) {
    return (
        <div className="flex flex-col items-center">
            ...
            <span className="text-[9px] md:text-[10px] text-gray-500 font-semibold uppercase mt-1">{label}</span>
        </div>
    );
}

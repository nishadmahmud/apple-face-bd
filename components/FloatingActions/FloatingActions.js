    ...
    return (
        <div className="fixed right-3 md:right-6 bottom-24 md:bottom-6 z-[80] flex flex-col gap-3">
            <a
                ...
                className="w-12 h-12 rounded-full bg-gradient-to-br from-[#00B2FF] to-[#006AFF] text-white shadow-xl flex items-center justify-center hover:scale-110 active:scale-95 transition-all duration-300 ring-4 ring-white"

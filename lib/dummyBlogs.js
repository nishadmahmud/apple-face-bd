...
export const DUMMY_BLOG_POSTS = [
  {
    ...
    excerpt:
      "A practical guide to picking the right iPhone model, storage, and warranty option when shopping at Apple Face.",
    content: `
      ...
      <p>At <strong>Apple Face</strong>, we recommend matching storage to how you use your phone. If you shoot a lot of 4K video or keep large apps, 256GB is a safer long-term choice than 128GB.</p>
  ...
  },
  {
    ...
    content: `
      ...
      <p>Need a phone with stronger battery out of the box? Ask our team at Apple Face—we can suggest models that fit your daily routine.</p>
    `,
    date: "March 8, 2026",
  ...
  },
  {
    ...
    title: "Why Shop Authentic Gadgets at Apple Face",
    excerpt:
      "Transparent pricing, genuine products, and local support—what sets Apple Face apart for tech shoppers in Dhaka.",
    content: `
      ...
      <p><strong>Apple Face</strong> focuses on genuine devices and honest advice. Our team helps you compare specs, EMI options, and warranty coverage before checkout.</p>
